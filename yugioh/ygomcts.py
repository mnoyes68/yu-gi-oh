...
class MCTS():
    ...
    def backFill(self, leaf, value, breadcrumbs):
        ...
        for edge in breadcrumbs:
            ...
            print 'updating edge with value %f for player %d... N = %d, W = %f, Q = %f' % ( value * direction
                , playerTurn
                , edge.stats['N']
                , edge.stats['W']
                , edge.stats['Q']
...
class YGOState():
    def __init__(self, state_id, playerTurn):
        self.id = state_id
        self.playerTurn = playerTurn

    def takeAction(action):
        return YGOState(0, 0), 0, 0


if __name__ == '__main__':
    state1 = YGOState(0, 0)
    root_node = Node(state1)
    ygotree = MCTS(root_node, 4)
